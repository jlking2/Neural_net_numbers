...
#np.savetxt('relu_nodes_test2L_CE.csv', relu_nodes_test2L, delimiter=',')
#np.savetxt('relu_nodes_test3L_CE.csv', relu_nodes_test3L, delimiter=',')
#np.savetxt('sigmoid_nodes_test2L_CE.csv', sigmoid_nodes_test2L, delimiter=',')
#np.savetxt('sigmoid_nodes_test3L_CE.csv', sigmoid_nodes_test3L, delimiter=',')
#
#np.savetxt('relu_epoch_test2L_CE.csv', relu_epoch_test2L, delimiter=',')
#np.savetxt('relu_epoch_test3L_CE.csv', relu_epoch_test3L, delimiter=',')
#np.savetxt('sigmoid_epoch_test2L_CE.csv', sigmoid_epoch_test2L, delimiter=',')
#np.savetxt('sigmoid_epoch_test3L_CE.csv', sigmoid_epoch_test3L, delimiter=',')
#
#np.savetxt('Epochs_CE.csv', epoch_list, delimiter=',')
#np.savetxt('noed_widths_CE.csv', nodes_list, delimiter=',')
#
#
#
#
