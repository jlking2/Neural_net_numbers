...
alpha_default = .1
L_default = 20
p_default = 30 #Can improve by increasing p
...
for rr in range(0,10):
    ...
    train_output = [U, V, W, err_rate, Yhat_big]
    u_list.append(train_output[0])
    v_list.append(train_output[1])
    w_list.append(train_output[2])
    y_list[:,rr] = np.squeeze(train_output[4])        
...
#print('Errors, first classifier:', err_rate)
#
#train_output = [U, V, W, err_c1, Yhat]
#    
#    
