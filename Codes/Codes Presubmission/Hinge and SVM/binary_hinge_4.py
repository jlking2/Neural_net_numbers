...
plt.xscale('log')
plt.title('Error rate vs Ridge Parameter, \u03BB. 0th-degree fits')
plt.grid(True)
...
plt.ylabel('Error Rate')
plt.xscale('log')
plt.title('Error rate vs Ridge Parameter, \u03BB. 1st-degree fits')
plt.grid(True)
plt.legend(('l1-regularized, squared hinge loss','l2-regularized, hinge loss','l2-regularized, squared hinge loss'))
plt.show()
...
plt.ylabel('Error Rate')
plt.xscale('log')
plt.title('Error rate vs Ridge Parameter, \u03BB. 2nd degree fits')
plt.grid(True)
plt.legend(('l1-regularized, squared hinge loss','l2-regularized, hinge loss','l2-regularized, squared hinge loss'))
plt.show()
