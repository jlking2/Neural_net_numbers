...
plt.figure(2)
plt.scatter(nodes_list, relu_MSE_nodes_test, linewidths = '1')
...
plt.figure(3)
plt.plot(nodes_list, relu_MSE_nodes_test,marker='v',markersize=12)
plt.plot(nodes_list, sigmoid_MSE_nodes_test,marker='v',markersize=12)
#plt.title('Predicted Labels, changing alpha')
plt.ylabel('accuracy')
plt.xlabel('width of hidden layers')
plt.legend(['relu', 'sigmoid'], loc='best')
