...
plt.figure(1)
plt.scatter(epoch_list, relu_MSE_epoch_test2L)
plt.scatter(epoch_list, sigmoid_MSE_epoch_test2L)
...
plt.figure(2)
plt.scatter(nodes_list, relu_MSE_nodes_test2L)
plt.scatter(nodes_list, sigmoid_MSE_nodes_test2L)
#plt.title('Predicted Labels, changing alpha')
plt.ylabel('accuracy')
